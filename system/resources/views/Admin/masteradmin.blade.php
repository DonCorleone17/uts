          ...
          <div id="sidebar" class="sidebar sidebar-with-footer">
            ...
            <div class="app-brand">
              <a href="adminindex">
                ...
                <span class="brand-name">BLOGSAT</span>
              </a>
            </div>
                        ...
                        <li  class="has-sub" >
                          ...
                          <ul  class="collapse"  id="components">
                            <div class="sub-menu">
                              ...
                              <li >
                                <a href="{{url('admin/artikel')}}">Posts</a>
                              </li>
                ...
                <ul class="nav navbar-nav">
                  ...
                  <li class="dropdown user-menu">
                    <button href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                      <img src="{{url('public')}}/admin/assets/img/user/user.png" class="user-image" alt="User Image" />
                      <span class="d-none d-lg-inline-block">@if(Auth::check()) {{request()->user()->nama}} @else Silahkan Login @endif</span>
                    </button>
                    <ul class="dropdown-menu dropdown-menu-right">
                      <!-- User image -->
                      <li class="dropdown-header">
                        <img src="{{url('public')}}/admin/assets/img/user/user.png" class="img-circle" alt="User Image" />
